...
const EventDashboard = () => {
  ...
  const renderTable = (typeEvents, typeName) => (
    <div className="text-black">
      ...
      <table className='table-auto w-full mt-4 border-collapse border border-gray-200 text-black text-sm rounded'>
        <thead>
          <tr className='bg-white rounded'>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Event ID</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Title</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Description</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Date</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Address</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Type</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Created By</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Created At</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Image</th>
            <th className='border-t border-b border-gray-300 px-4 py-2'>Pick</th>
          </tr>
        </thead>
        <tbody>
          {typeEvents.map(([eventId, event]) => (
            <tr key={eventId}>
              <td className='border-t border-b border-gray-300 px-4 py-2'>{eventId}</td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>{event.title}</td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>{event.desc}</td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>{new Date(event.date).toLocaleDateString()}</td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>{event.location_name}</td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>
                {event.type === 'I' ? 'Internal' :
                event.type === 'E' ? 'External' :
                'Unknown Division'}
              </td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>{event.created_by}</td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>{new Date(event.created_at).toLocaleString()}</td>
              <td className='border-t border-b border-gray-300 px-4 py-2'>
